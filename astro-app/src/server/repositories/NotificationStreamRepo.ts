...
import { toNotificationRow, type NotificationRow } from "./NotificationsRepo";
        ...
        const rows = await exec
            ...
            .where(
                and(
                    ...
                    // SQLite stores internal_id as a plain INTEGER (number);
                    // the public bigint cursor is narrowed at this boundary.
                    gt(notifications.internalId, Number(afterInternalId)),
