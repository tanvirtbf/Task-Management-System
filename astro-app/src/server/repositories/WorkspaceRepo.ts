...
export class WorkspaceRepo {
    ...
    /**
     * Same projection as `findById`, but for read-merge-write inside one
     * transaction without a lost-update race (used by the PATCH business-hours
     * merge check). Must run inside a transaction — pass the `tx` executor.
