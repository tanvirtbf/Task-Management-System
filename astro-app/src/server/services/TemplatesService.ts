 ...
 *  or a generic `SQLITE_CONSTRAINT` whose message names the UNIQUE constraint). */
...
export class TemplatesService {
     ...
     * (`(workspace_id, name)` UNIQUE; case-SENSITIVE on SQLite — MySQL's
     * `utf8mb4_unicode_ci` was case-insensitive) surfaces as
     * `409 template.duplicate`.
     */
