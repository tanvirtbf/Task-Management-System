...
/** libsql surfaces a unique-violation as `SQLITE_CONSTRAINT_UNIQUE`. */
...
/**
 * SQLite surfaces a missing FK parent (the referenced task was deleted) as
 * `SQLITE_CONSTRAINT_FOREIGNKEY` — the race-safe backstop behind the
