...
- **#5 download** must verify the caller has read access to the parent task before issuing the redirect. The signed GET URL has a 5-min default TTL (per API_DESIGN.md §16 / Appendix A).
