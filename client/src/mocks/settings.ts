...
export const integrations: Integration[] = [
    {
        ...
        connectedBy: "u-001",
        meta: { workspace: "shutkihut", channel: "#operations" },
    },
    {
        id: "int-discord",
        name: "Discord",
    ...
    },
    {
        ...
        name: "Gmail",
        description:
            "Convert emails into tasks and reply directly from comments.",
        category: "email",
        icon: "Mail",
        color: "#EA4335",
        isConnected: true,
        ...
        connectedBy: "u-001",
        meta: { account: "ops@shutkihut.com" },
    },
    {
        id: "int-outlook",
        name: "Outlook",
...
export const webhooks: Webhook[] = [
    ...
    },
    {
        ...
        url: "https://api.shutkihut.internal/webhooks/tasks",
    ...
    },
    {
        ...
        url: "https://api.shutkihut.internal/webhooks/forms",
...
export const notificationPreferencesByUser: Map<string, NotificationPreferences> =
    new Map();
