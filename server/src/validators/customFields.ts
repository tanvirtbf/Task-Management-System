...
import { customFieldScopeTypes } from "../db/schema/_shared";
...
export const listCustomFieldsValidator = checkSchema({
    scope_type: {
        in: ["query"],
        optional: true,
        isIn: {
            options: [[...customFieldScopeTypes]],
            errorMessage: `scope_type must be one of: ${customFieldScopeTypes.join(", ")}`,
        },
    },
    scope_id: {
        in: ["query"],
...
export const listForListValidator = checkSchema({
    listId: {
        in: ["params"],
        trim: true,
...
export const createCustomFieldValidator = checkSchema({
    scope_type: {
        in: ["body"],
        isIn: {
            options: [[...customFieldScopeTypes]],
 ...
 */
export const updateCustomFieldValidator = checkSchema({
    id: idParam,
    name: {
        in: ["body"],
        optional: true,
    ...
    type: {
        in: ["body"],
        custom: {
            options: (value: unknown) => value === undefined,
...
export const customFieldIdParamValidator = checkSchema({ id: idParam });
 ...
 */
export const taskFieldParamsValidator = checkSchema({
    id: idParam,
    fieldId: {
        in: ["params"],
        trim: true,
