...
const GARBAGE: Array<[string, unknown]> = [
    ...
    ["get_person_tasks", {}],
    ["get_person_tasks", { person_name: 42 }],
    ["get_person_tasks", { person_name: "x", bucket: "kal" }],
    ["get_person_tasks", { person_name: "x", bucket: "completed", window_days: "7din" }],
    ["get_team_stats", {}],
    ["get_team_stats", { team_name: 42 }],
    ["get_team_stats", { team_name: "x", window_days: "soptaho" }],
