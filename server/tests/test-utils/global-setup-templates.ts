...
/**
 * Isolated global-setup for the §23 Templates suite.
 *
 ...
 * so overriding the property here (and in `db-name-templates.ts` for the test
 * runtime) is enough — no shared file or `src` change required. Mirrors the
 * §8 Task types / §7 Statuses private-config pattern.
 */
