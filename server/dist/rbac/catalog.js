...
exports.strongerScope = exports.permissionsByGroup = exports.supportsScope = exports.isPermissionKey = exports.getPermission = exports.PERMISSION_KEYS = exports.PERMISSIONS = exports.PERMISSION_GROUP_LABELS = exports.PERMISSION_GROUPS = exports.PERMISSION_SCOPES = void 0;
/** How widely a granted permission applies. Ordered weakest → strongest. */
exports.PERMISSION_SCOPES = ["own", "space", "all"];
...
exports.PERMISSION_GROUP_LABELS = {
    workspace: "Workspace",
    members: "Members",
...
const ALL = ["all"];
const ALL_SPACE = ["all", "space"];
const ALL_SPACE_OWN = ["all", "space", "own"];
/**
...
const PERMISSION_DEFS = [
    // ── workspace ───────────────────────────────────────────────────────────
    {
        ...
        description: "Change the workspace name, timezone, working days and business hours.",
        scopes: ALL,
    },
    // ── members ─────────────────────────────────────────────────────────────
    {
        ...
        description: "See the list of people in the workspace (needed for assignee and @mention pickers).",
        scopes: ALL,
    },
    {
        key: "member.invite",
    ...
    },
    {
        ...
        description: "Assign a different workspace role to another member. The owner's role can never be changed.",
        scopes: ALL,
        dangerous: true,
    },
    {
        ...
        description: "Disable or restore a member's access. The owner cannot be deactivated, and nobody can deactivate themselves.",
        scopes: ALL,
        dangerous: true,
    },
    {
    ...
    },
    {
        ...
        description: "Change another member's name, email or timezone. Editing your own profile never needs a permission.",
        scopes: ALL,
    },
    // ── spaces ──────────────────────────────────────────────────────────────
    {
        ...
        group: "spaces",
        label: "See spaces",
        description: "The main visibility switch. With scope 'all' a person sees every space; with 'space' they see only the spaces they are assigned to. Lists, tasks and everything inside follow this.",
        scopes: ALL_SPACE,
    },
    {
        key: "space.create",
    ...
    },
    {
        ...
        description: "Permanently remove an archived, empty space. Cannot be undone.",
        scopes: ALL_SPACE,
        dangerous: true,
    },
    {
        ...
        description: "Choose which person reviews the work of a space and receives its weekly report.",
        scopes: ALL_SPACE,
    },
    {
        ...
        description: "Add or remove people from a space and choose the role they hold there.",
        scopes: ALL_SPACE,
        dangerous: true,
    },
    // ── structure (lists + statuses) ────────────────────────────────────────
    ...
    },
    {
        ...
        description: "Create, rename, reorder and delete the workflow columns of a list.",
        scopes: ALL_SPACE,
    },
    // ── tasks ───────────────────────────────────────────────────────────────
    {
        ...
        group: "tasks",
        label: "See tasks",
        description: "With scope 'own', a person still sees tasks they created or are assigned to even outside their spaces — this keeps cross-department work (like a reported bug) visible to its reporter.",
    ...
    },
    {
        ...
        group: "tasks",
        label: "Edit tasks",
        description: "Change a task's name, description, status, priority, dates, tags and other fields.",
        scopes: ALL_SPACE_OWN,
    },
    {
        key: "task.assign",
        ...
        description: "Add or remove assignees on a task. Without this, a person can still work on tasks assigned to them.",
        scopes: ALL_SPACE,
    },
    {
        key: "task.archive",
    ...
    },
    {
        ...
        description: "Erase a task and all of its comments, checklists and attachments. Cannot be undone.",
        scopes: ALL_SPACE,
        dangerous: true,
    },
    {
    ...
    // ── content ─────────────────────────────────────────────────────────────
    {
        ...
        description: "Post comments and @mention teammates. Editing or deleting your OWN comment never needs a permission.",
        scopes: ALL_SPACE,
    },
    {
    ...
    },
    {
        ...
        description: "Remove a file uploaded by someone else. Deleting your own upload never needs a permission.",
        scopes: ALL_SPACE,
        dangerous: true,
    },
    {
    ...
    },
    {
        ...
        description: "Write values into the extra fields on a task. Creating the fields themselves is a separate permission.",
        scopes: ALL_SPACE_OWN,
    },
    // ── catalog ─────────────────────────────────────────────────────────────
    {
    ...
    },
    {
        ...
        description: "Define the extra fields available on tasks, and which of them are hidden from guests.",
        scopes: ALL,
    },
    {
    ...
    // ── forms ───────────────────────────────────────────────────────────────
    {
        ...
        description: "Create, edit, publish and delete public intake forms and their fields.",
        scopes: ALL_SPACE,
    },
    {
        ...
        description: "Read what people submitted through a public form (may contain personal data).",
        scopes: ALL_SPACE,
    },
    // ── engineering ─────────────────────────────────────────────────────────
    {
        ...
        description: "Create, edit, start and close sprints. Sprints are workspace-wide, so this cannot be limited to one space.",
        scopes: ALL,
    },
    {
    ...
    },
    {
        ...
        description: "Choose which engineer is on call each week. On-call is workspace-wide.",
        scopes: ALL,
    },
    {
        key: "bug.report",
        group: "engineering",
        label: "Report a bug",
        description: "File a bug from anywhere in the app; it lands in the engineering Bug Triage list.",
        scopes: ALL,
    },
    {
    ...
    // ── department review & reports ─────────────────────────────────────────
    {
        ...
        description: "Approve a finished task or flag it with a note asking for another pass. Normally given to a department head with scope 'space'.",
        scopes: ALL_SPACE,
    },
    {
        key: "review.read",
        ...
        description: "Open the Department page and read the approve/flag history of tasks. Scope 'own' lets a person see the verdicts on their own tasks.",
        scopes: ALL_SPACE_OWN,
    },
    {
        key: "report.view",
    ...
    },
    {
        ...
        description: "Build a department's weekly report on demand instead of waiting for Monday.",
        scopes: ALL_SPACE,
    },
    {
        key: "report.note",
        ...
        description: "Add the department head's written context to a weekly report for HR.",
        scopes: ALL_SPACE,
    },
    {
        key: "report.ack",
        ...
        description: "Acknowledge on behalf of HR/management that a weekly report has been read.",
        scopes: ALL_SPACE,
    },
    // ── insights ────────────────────────────────────────────────────────────
    {
        ...
        description: "Read the audit trail of changes across the workspace. This feed is workspace-wide, so it cannot be limited to one space.",
        scopes: ALL,
    },
    {
        key: "assistant.use",
        ...
        description: "Ask the in-app assistant questions. It can only ever show what the person is already allowed to see.",
        scopes: ALL,
    },
    // ── rbac ────────────────────────────────────────────────────────────────
    {
        ...
        description: "Define roles and choose the permissions each one grants. Whoever holds this controls the whole permission system.",
        scopes: ALL,
        dangerous: true,
    },
    {
        ...
        description: "Assign or remove a role for a person, workspace-wide or inside one space.",
        scopes: ALL,
        dangerous: true,
    },
];
/** THE CATALOG, as consumers see it. Same array, widened to `PermissionDef`. */
exports.PERMISSIONS = PERMISSION_DEFS;
/**
 ...
 */
exports.PERMISSION_KEYS = PERMISSION_DEFS.map((p) => p.key);
const BY_KEY = new Map(exports.PERMISSIONS.map((p) => [p.key, p]));
/** Look up one permission definition, or undefined for an unknown key. */
const getPermission = (key) => BY_KEY.get(key);
exports.getPermission = getPermission;
/** True when `key` exists in the catalog. */
const isPermissionKey = (key) => BY_KEY.has(key);
exports.isPermissionKey = isPermissionKey;
/** True when `scope` may be granted for `key` (unknown key → false). */
const supportsScope = (key, scope) => {
    const def = BY_KEY.get(key);
    if (!def)
        return false;
    return def.scopes.includes(scope);
};
exports.supportsScope = supportsScope;
/**
 * Catalog grouped for the admin UI, in group order then definition order.
 * Groups with no permissions are omitted.
 */
const permissionsByGroup = () => exports.PERMISSION_GROUPS.map((group) => ({
    group,
    label: exports.PERMISSION_GROUP_LABELS[group],
    permissions: exports.PERMISSIONS.filter((p) => p.group === group),
})).filter((g) => g.permissions.length > 0);
exports.permissionsByGroup = permissionsByGroup;
/**
 ...
 */
const strongerScope = (a, b) => exports.PERMISSION_SCOPES.indexOf(a) >= exports.PERMISSION_SCOPES.indexOf(b) ? a : b;
exports.strongerScope = strongerScope;
