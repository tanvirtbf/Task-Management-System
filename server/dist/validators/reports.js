...
exports.ackReportValidator = exports.headNoteValidator = exports.generateReportValidator = exports.getReportValidator = exports.listReportsValidator = void 0;
...
exports.listReportsValidator = (0, express_validator_1.checkSchema)({
    space_id: {
        in: ["query"],
        optional: true,
...
exports.getReportValidator = (0, express_validator_1.checkSchema)({
    id: {
        in: ["params"],
        trim: true,
 ...
 * `report.invalid_week`).
 */
exports.generateReportValidator = (0, express_validator_1.checkSchema)({
    space_id: {
        in: ["body"],
        isString: { errorMessage: "space_id must be a string", bail: true },
        trim: true,
 ...
 */
exports.headNoteValidator = (0, express_validator_1.checkSchema)({
    id: {
        in: ["params"],
        trim: true,
        notEmpty: { errorMessage: "id is required" },
        ...
        custom: {
            options: (value) => {
                ...
                if (value.length > 1000) {
                    throw new Error("head_note must be at most 1000 characters");
                }
                return true;
            },
        },
...
exports.ackReportValidator = (0, express_validator_1.checkSchema)({
    id: {
        in: ["params"],
        trim: true,
        notEmpty: { errorMessage: "id is required" },
