...
exports.updatePreferencesValidator = exports.snoozeNotificationValidator = exports.notificationIdValidator = exports.listNotificationsValidator = void 0;
...
exports.listNotificationsValidator = (0, express_validator_1.checkSchema)({
    cursor: {
        in: ["query"],
        optional: true,
 ...
 */
exports.notificationIdValidator = (0, express_validator_1.checkSchema)({
    id: {
        in: ["params"],
        trim: true,
 ...
 */
exports.snoozeNotificationValidator = (0, express_validator_1.checkSchema)({
    id: {
        in: ["params"],
        trim: true,
        notEmpty: { errorMessage: "id must not be empty" },
...
exports.updatePreferencesValidator = [
    (0, express_validator_1.body)().custom((value) => {
        ...
        if (entries.length === 0) {
            throw new Error("Provide at least one notification-type preference to update");
        }
        const allowed = new Set(_shared_1.notificationTypes);
        for (const [type, pref] of entries) {
            ...
            if (extra.length > 0) {
                throw new Error(`Preference for "${type}" has unknown keys: ${extra.join(", ")}`);
            }
        }
        return true;
    }),
