...
exports.weekStartParamValidator = exports.setOnCallValidator = exports.scheduleQueryValidator = void 0;
 ...
 */
exports.scheduleQueryValidator = (0, express_validator_1.checkSchema)({
    from: {
        in: ["query"],
        optional: true,
 ...
 */
exports.setOnCallValidator = (0, express_validator_1.checkSchema)({
    weekStart: {
        in: ["params"],
        trim: true,
        ...
        custom: {
            options: (value) => {
                if (!isMondayIsoDate(value)) {
                    throw new Error("weekStart must be a Monday in YYYY-MM-DD format");
                }
                return true;
            },
        },
 ...
 */
exports.weekStartParamValidator = (0, express_validator_1.checkSchema)({
    weekStart: {
        in: ["params"],
        trim: true,
        notEmpty: { errorMessage: "weekStart is required", bail: true },
