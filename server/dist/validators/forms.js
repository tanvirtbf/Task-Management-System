...
exports.submitFormValidator = exports.listSubmissionsValidator = exports.reorderFieldsValidator = exports.updateFieldValidator = exports.addFieldValidator = exports.updateFormValidator = exports.createFormValidator = exports.fieldIdParamValidator = exports.formIdParamValidator = exports.listByListFormsValidator = void 0;
...
exports.listByListFormsValidator = (0, express_validator_1.checkSchema)({
    listId: {
        in: ["params"],
        isString: true,
        trim: true,
...
exports.formIdParamValidator = (0, express_validator_1.checkSchema)({
    id: {
        in: ["params"],
        isString: true,
        trim: true,
...
exports.fieldIdParamValidator = (0, express_validator_1.checkSchema)({
    id: {
        in: ["params"],
        isString: true,
        trim: true,
...
/** `POST /api/v1/forms` (#4). */
exports.createFormValidator = (0, express_validator_1.checkSchema)({
    list_id: {
        in: ["body"],
    ...
    public_slug: {
        ...
        matches: {
            options: SLUG_RE,
            errorMessage: "public_slug must be lowercase alphanumeric words joined by hyphens",
        },
    },
    settings: {
        in: ["body"],
...
exports.updateFormValidator = (0, express_validator_1.checkSchema)({
    id: {
        in: ["params"],
        isString: true,
        trim: true,
...
exports.addFieldValidator = (0, express_validator_1.checkSchema)({
    id: {
        in: ["params"],
        isString: true,
        trim: true,
    ...
    field_kind: {
        in: ["body"],
        isIn: {
            options: [_shared_1.formFieldKinds],
            errorMessage: `field_kind must be one of: ${_shared_1.formFieldKinds.join(", ")}`,
        },
    },
    field_key: {
        in: ["body"],
...
exports.updateFieldValidator = (0, express_validator_1.checkSchema)({
    id: {
        in: ["params"],
        isString: true,
        trim: true,
...
exports.reorderFieldsValidator = (0, express_validator_1.checkSchema)({
    id: {
        in: ["params"],
        isString: true,
        trim: true,
...
exports.listSubmissionsValidator = (0, express_validator_1.checkSchema)({
    id: {
        in: ["params"],
        isString: true,
        trim: true,
...
exports.submitFormValidator = (0, express_validator_1.checkSchema)({
    slug: {
        in: ["params"],
        isString: true,
        trim: true,
