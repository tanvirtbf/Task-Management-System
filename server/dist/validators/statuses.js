...
exports.reorderStatusesValidator = exports.deleteStatusValidator = exports.updateStatusValidator = exports.createStatusValidator = exports.listStatusesValidator = void 0;
 ...
 */
exports.listStatusesValidator = (0, express_validator_1.checkSchema)({
    listId: {
        in: ["params"],
        trim: true,
        notEmpty: {
 ...
 */
exports.createStatusValidator = (0, express_validator_1.checkSchema)({
    listId: {
        in: ["params"],
        trim: true,
        notEmpty: {
    ...
    status_group: {
        ...
        isIn: {
            options: [[..._shared_1.statusGroups]],
            errorMessage: `status_group must be one of: ${_shared_1.statusGroups.join(", ")}`,
        },
    },
    color: {
        in: ["body"],
 ...
 */
exports.updateStatusValidator = (0, express_validator_1.checkSchema)({
    id: {
        in: ["params"],
        trim: true,
        notEmpty: {
 ...
 * guards.
 */
exports.deleteStatusValidator = (0, express_validator_1.checkSchema)({
    id: {
        in: ["params"],
        trim: true,
        notEmpty: {
 ...
 */
exports.reorderStatusesValidator = (0, express_validator_1.checkSchema)({
    listId: {
        in: ["params"],
        trim: true,
        notEmpty: {
