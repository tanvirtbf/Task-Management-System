...
exports.updateTaskValidator = exports.createTaskValidator = exports.taskActivityValidator = exports.listTasksValidator = exports.subtasksValidator = exports.getTaskValidator = exports.removeTagValidator = exports.addTagsValidator = exports.watchSelfValidator = exports.deleteAssigneeValidator = exports.addAssigneesValidator = exports.bulkTasksValidator = exports.myWorkValidator = void 0;
 ...
 */
const csvMembersAllowed = (allowed) => (value) => value
    .split(",")
 ...
 */
exports.myWorkValidator = (0, express_validator_1.checkSchema)({
    bucket: {
        in: ["query"],
        optional: true,
        isIn: {
            options: [["today", "overdue", "next", "unscheduled", "done"]],
            errorMessage: "bucket must be one of: today, overdue, next, unscheduled, done",
        },
    },
});
/**
 ...
 */
exports.bulkTasksValidator = (0, express_validator_1.checkSchema)({
    ids: {
        in: ["body"],
        isArray: {
 ...
 */
exports.addAssigneesValidator = (0, express_validator_1.checkSchema)({
    id: {
        in: ["params"],
        trim: true,
    ...
    user_ids: {
        ...
        isArray: {
            ...
            errorMessage: "user_ids must be a non-empty array of at most 50 ids",
        },
    },
    "user_ids.*": {
        in: ["body"],
    ...
    user_id: {
        ...
        custom: {
            options: (_value, { req }) => {
                const body = (req.body ?? {});
                const hasId = body.user_id !== undefined && body.user_id !== null;
                const hasIds = body.user_ids !== undefined && body.user_ids !== null;
                if (hasId) {
                    const value = body.user_id;
                    if (typeof value !== "string" ||
                        value.trim().length < 1 ||
                        value.trim().length > MAX_ID_LENGTH) {
                        throw new Error("user_id must be a string of 1–64 characters");
                    }
                }
                if (!hasId && !hasIds) {
 ...
 */
exports.deleteAssigneeValidator = (0, express_validator_1.checkSchema)({
    id: {
        in: ["params"],
        trim: true,
        notEmpty: { errorMessage: "Task id is required" },
 ...
 */
exports.watchSelfValidator = (0, express_validator_1.checkSchema)({
    id: {
        in: ["params"],
        trim: true,
        notEmpty: { errorMessage: "Task id is required" },
 ...
 */
exports.addTagsValidator = (0, express_validator_1.checkSchema)({
    id: {
        in: ["params"],
        trim: true,
        notEmpty: { errorMessage: "Task id is required" },
    ...
    tag_id: {
        ...
        custom: {
            options: (_value, { req }) => {
                ...
                const hasIds = body.tag_ids !== undefined && body.tag_ids !== null;
                if (hasId) {
                    const value = body.tag_id;
                    if (typeof value !== "string" ||
                        value.trim().length < 1 ||
                        value.trim().length > MAX_ID_LENGTH) {
                        throw new Error("tag_id must be a string of 1–64 characters");
                    }
                }
                if (!hasId && !hasIds) {
 ...
 */
exports.removeTagValidator = (0, express_validator_1.checkSchema)({
    id: {
        in: ["params"],
        trim: true,
        notEmpty: { errorMessage: "Task id is required" },
 ...
 */
exports.subtasksValidator = (0, express_validator_1.checkSchema)({
    id: {
        in: ["params"],
        trim: true,
        notEmpty: { errorMessage: "Task id is required" },
 ...
 */
exports.listTasksValidator = (0, express_validator_1.checkSchema)({
    listId: {
        in: ["params"],
        trim: true,
    ...
    status_group: {
        ...
        custom: {
            options: csvMembersAllowed(_shared_1.statusGroups),
            errorMessage: `status_group members must be one of: ${_shared_1.statusGroups.join(", ")}`,
        },
    },
    assignee: {
        in: ["query"],
    ...
    bug_severity: {
        ...
        custom: {
            options: csvMembersAllowed(_shared_1.bugSeverities),
            errorMessage: `bug_severity members must be one of: ${_shared_1.bugSeverities.join(", ")}`,
        },
    },
    q: {
        in: ["query"],
 ...
 */
exports.taskActivityValidator = (0, express_validator_1.checkSchema)({
    id: {
        in: ["params"],
        trim: true,
        notEmpty: { errorMessage: "Task id is required" },
...
exports.createTaskValidator = (0, express_validator_1.checkSchema)({
    ...
    recurrence_pattern: {
        ...
        optional: true,
        isIn: {
            options: [[..._shared_1.recurrencePatterns]],
            errorMessage: `recurrence_pattern must be one of: ${_shared_1.recurrencePatterns.join(", ")}`,
        },
    },
    recurrence_days: {
        in: ["body"],
    ...
    "recurrence_days.*": {
        in: ["body"],
        isIn: {
            options: [[..._shared_1.weekDays]],
            errorMessage: `recurrence_days members must be one of: ${_shared_1.weekDays.join(", ")}`,
        },
    },
    recurrence_ends_at: {
        in: ["body"],
    ...
    pr_status: {
        ...
        optional: optNullable,
        isIn: {
            options: [[..._shared_1.prStatuses]],
            errorMessage: `pr_status must be one of: ${_shared_1.prStatuses.join(", ")}`,
        },
    },
    bug_severity: {
        in: ["body"],
        optional: optNullable,
        isIn: {
            options: [[..._shared_1.bugSeverities]],
            errorMessage: `bug_severity must be one of: ${_shared_1.bugSeverities.join(", ")}`,
        },
    },
    bug_reproducibility: {
        in: ["body"],
        optional: optNullable,
        isIn: {
            options: [[..._shared_1.bugReproducibilities]],
            errorMessage: `bug_reproducibility must be one of: ${_shared_1.bugReproducibilities.join(", ")}`,
        },
    },
    bug_environment: {
        in: ["body"],
        optional: optNullable,
        isIn: {
            options: [[..._shared_1.bugEnvironments]],
            errorMessage: `bug_environment must be one of: ${_shared_1.bugEnvironments.join(", ")}`,
        },
    },
    bug_browser: {
        in: ["body"],
    ...
    reporter_team: {
        ...
        optional: optNullable,
        isIn: {
            options: [[..._shared_1.reporterTeams]],
            errorMessage: `reporter_team must be one of: ${_shared_1.reporterTeams.join(", ")}`,
        },
    },
    deployed_at: {
        in: ["body"],
