...
exports.removeSprintTaskValidator = exports.addSprintTasksValidator = exports.updateSprintValidator = exports.createSprintValidator = exports.sprintIdParamValidator = exports.listSprintsValidator = void 0;
...
const NAME_MAX = _shared_1.SHORT_NAME_LENGTH; // sprints.name VARCHAR(80)
...
exports.listSprintsValidator = (0, express_validator_1.checkSchema)({
    status: {
        in: ["query"],
        optional: true,
        isIn: {
            options: [[..._shared_1.sprintStatuses]],
            errorMessage: `status must be one of: ${_shared_1.sprintStatuses.join(", ")}`,
        },
    },
});
/** Shared `:id` guard for `GET /sprints/:id`, `POST /:id/start`, `/:id/close`. */
exports.sprintIdParamValidator = (0, express_validator_1.checkSchema)({ id: idParam });
/**
 ...
 */
exports.createSprintValidator = (0, express_validator_1.checkSchema)({
    name: {
        in: ["body"],
 ...
 */
exports.updateSprintValidator = (0, express_validator_1.checkSchema)({
    id: idParam,
    name: {
        in: ["body"],
        optional: true,
 ...
 */
exports.addSprintTasksValidator = (0, express_validator_1.checkSchema)({
    id: idParam,
    task_ids: {
        in: ["body"],
        isArray: {
...
exports.removeSprintTaskValidator = (0, express_validator_1.checkSchema)({
    id: idParam,
    taskId: {
        in: ["params"],
        trim: true,
