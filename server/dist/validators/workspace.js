...
exports.workspaceUpdateValidator = (0, express_validator_1.checkSchema)({
        ...
        custom: {
            options: (value) => {
                ...
                if (value.length > URL_MAX) {
                    throw new Error(`logo_url must be at most ${URL_MAX} characters`);
                }
            ...
            options: (value) => {
                ...
                for (const day of value) {
                    if (typeof day !== "string" || !allowed.includes(day)) {
                        throw new Error(`working_days members must each be one of: ${_shared_1.weekDays.join(", ")}`);
                    }
                }
                return true;
            },
    ...
    default_locale: {
        ...
        custom: {
            options: (value) => {
                if (value !== undefined) {
                    throw new Error("default_locale cannot be updated via this endpoint");
                }
                return true;
            },
        },
