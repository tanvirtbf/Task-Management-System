...
exports.downloadAttachmentValidator = exports.deleteAttachmentValidator = exports.listAttachmentsValidator = exports.finalizeValidator = exports.signUploadValidator = void 0;
...
exports.signUploadValidator = (0, express_validator_1.checkSchema)({
    scope_type: {
        in: ["body"],
        trim: true,
...
exports.finalizeValidator = (0, express_validator_1.checkSchema)({
    id: idParam(),
    storage_key: {
        in: ["body"],
        optional: true,
...
exports.listAttachmentsValidator = (0, express_validator_1.checkSchema)({ id: idParam() });
/** `DELETE /api/v1/attachments/:id`. */
exports.deleteAttachmentValidator = (0, express_validator_1.checkSchema)({ id: idParam() });
/** `GET /api/v1/attachments/:id/download`. */
exports.downloadAttachmentValidator = (0, express_validator_1.checkSchema)({ id: idParam() });
