...
exports.createReviewValidator = exports.listReviewsValidator = exports.reviewQueueValidator = exports.reviewSummaryValidator = void 0;
...
exports.reviewSummaryValidator = (0, express_validator_1.checkSchema)({
    id: {
        in: ["params"],
        trim: true,
 ...
 */
exports.reviewQueueValidator = (0, express_validator_1.checkSchema)({
    id: {
        in: ["params"],
        trim: true,
        notEmpty: { errorMessage: "id is required" },
    ...
    bucket: {
        ...
        isIn: {
            ...
            errorMessage: "bucket must be one of needs_review, flagged, overdue, due_today",
        },
    },
    member_id: {
        in: ["query"],
...
exports.listReviewsValidator = (0, express_validator_1.checkSchema)({
    id: {
        in: ["params"],
        trim: true,
        notEmpty: { errorMessage: "id is required" },
...
exports.createReviewValidator = (0, express_validator_1.checkSchema)({
    id: {
        in: ["params"],
        trim: true,
        notEmpty: { errorMessage: "id is required" },
