...
exports.conversationParamValidator = exports.chatValidator = void 0;
 ...
 */
exports.chatValidator = (0, express_validator_1.checkSchema)({
    message: {
        in: ["body"],
...
exports.conversationParamValidator = (0, express_validator_1.checkSchema)({
    id: {
        in: ["params"],
