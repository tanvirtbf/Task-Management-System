...
exports.getListValidator = exports.updateListValidator = exports.createListValidator = exports.listAllValidator = exports.listBySpaceValidator = void 0;
...
exports.listBySpaceValidator = (0, express_validator_1.checkSchema)({
    spaceId: {
        in: ["params"],
        trim: true,
        notEmpty: {
 ...
 * boolean spellings.
 */
exports.listAllValidator = (0, express_validator_1.checkSchema)({
    space_id: {
        in: ["query"],
        optional: true,
        trim: true,
 ...
 */
exports.createListValidator = (0, express_validator_1.checkSchema)({
    space_id: {
        in: ["body"],
    ...
    default_task_type_id: {
        ...
        optional: true,
        customSanitizer: {
            options: (value) => typeof value === "string" ? value.trim() : value,
        },
        custom: {
            options: (value) => {
                if (value === null)
                ...
                throw new Error(`default_task_type_id must be a non-empty id string (max ${ID_MAX} chars) or null`);
            },
        },
    },
});
 ...
 * task type only.
 */
exports.updateListValidator = (0, express_validator_1.checkSchema)({
    id: {
        in: ["params"],
        trim: true,
    ...
    description: {
        ...
        custom: {
            options: (value) => {
                ...
                throw new Error(`description must be a string (max ${DESCRIPTION_MAX} chars) or null`);
            },
        },
    },
    icon: {
 ...
 */
exports.getListValidator = (0, express_validator_1.checkSchema)({
    id: {
        in: ["params"],
        trim: true,
        notEmpty: {
